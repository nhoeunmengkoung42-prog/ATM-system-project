...
class ATM {
    ...
    private void createAdminAccount() {
        ...
        try {
            ...
            boolean success = adminDatabase.createAdmin(admin);
            ...
            try {
                switch (choice) {
                    ...
                    case 2:
                        ...
                        double deposit = ATMSystemInput.readDouble(sc);
                    ...
                    case 3:
                        ...
                        double withdraw = ATMSystemInput.readDouble(sc);
                    ...
                    case 7:
                        int before = account.getTransactions().size();

                        account.monthlyUpdate();
                        bank.saveAccount(account);

                        if (account.getTransactions().size() > before) {
                            bank.saveLatestTransaction(account);
                        }
                        break;
    ...
    private void transfer(Account sender) {
        ...
        try {
            ...
            double amount = ATMSystemInput.readDouble(sc);
